      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sign in to your ExamTrack360 account
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <div className="text-xs text-blue-700 space-y-1">
            <p><strong>Admin:</strong> admin@examtrack360.com / password123</p>
            <p><strong>Teacher:</strong> teacher@examtrack360.com / password123</p>
            <p><strong>Student:</strong> student@examtrack360.com / password123</p>
          </div>
        </div>
      </div>
    </div>
